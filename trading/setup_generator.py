...
from config import (
    ...
    SETUP_LOOKBACK_LONG, SETUP_SWING_LOW_WINDOW, SETUP_SWING_LOW_RECENCY,
    SETUP_SWING_LOW_STRENGTH, SETUP_SWING_LOW_MAX_ATR,
    SETUP_MIN_RESISTANCE_TESTS, SETUP_QUALITY_THRESHOLDS,
)
